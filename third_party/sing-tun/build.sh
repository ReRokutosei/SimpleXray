...
echo "=== Building SingTUN bridge for Android (arm64-v8a) ==="
...
OUTPUT_SO="${SCRIPT_DIR}/libsingtun.so"
...
mkdir -p "${DEST_DIR}"
cp -f "${OUTPUT_SO}" "${DEST_DIR}/libsingtun.so"

echo "=== Successfully built and installed: ${DEST_DIR}/libsingtun.so ==="
